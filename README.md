...
|---|---|---|
| 🟢 **DJ 6 AI host** ✨ new | PR [#67](https://github.com/ufoptg/MuSicX/pull/67) | In-app AI DJ that curates the next tracks (OpenRouter) and speaks sparse, natural banter with cloud TTS (Deepgram Flux via OpenRouter) or device TTS. Start from *Library Mix → DJ 6*, the player menu, or “DJ 6 play …”. Settings under *Integrations → DJ 6*. Optional hands-free **Hey DJ 6 …** wake (on-device Vosk model, downloads once) plus Talk to DJ 6 push-to-talk backup — must say **DJ 6**. |
...
- **DJ 6 AI host** — curated radio + natural banter + “DJ 6 …” voice commands ✨
...
- **DJ 6** — Library Mix tile + Integrations settings + Talk to DJ 6 ✨
